...
const handleResize = () => {
    const isLargeScreen = window.innerWidth >= 1024; // lg breakpoint (matches lg:hidden)
    if (isLargeScreen && isSidebarOpen.value) {
        console.log('Closing sidebar - screen is large');
...
onMounted(() => {
    console.log('AppHeader mounted, adding resize listener');
    window.addEventListener('resize', handleResize);
    // Also check on mount in case user starts on large screen
    handleResize();
});

onUnmounted(() => {
    console.log('AppHeader unmounted, removing resize listener');
    ...
    <div>
        <div class="border-b border-sidebar-border/80">
            <div class="mx-auto flex h-16 items-center px-4 md:max-w-7xl">
                ...
                <div class="lg:hidden">
                    <Sheet v-model:open="isSidebarOpen">
                        ...
                        <SheetContent side="left" class="w-[300px] p-6">
                            ...
                            <SheetHeader class="flex flex-row items-center justify-start text-left">
                                <AppLogo />
                            </SheetHeader>
                ...
                <Link href="/student/courses" class="flex items-center gap-x-2">
                    <AppLogo />
                </Link>

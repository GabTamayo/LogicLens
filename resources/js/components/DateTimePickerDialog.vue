...
<template>
    <div class="flex">
        ...
        <div class="flex flex-row h-[300px] w-full divide-x">
            <ScrollArea class="w-auto sm:w-13">
                <div class="flex flex-col">
                    <Button v-for="hour in hours" :key="hour" size="icon"
                        ...
                        class="w-full shrink-0 aspect-square" type="button" @click="handleTimeChange('hour', hour)">
                        {{ hour }}
                    </Button>
                </div>
            </ScrollArea>
            ...
            <ScrollArea class="w-auto sm:w-13">
                <div class="flex flex-col">
                    <Button v-for="minute in minutes" :key="minute" size="icon"
                        ...
                        class="w-full shrink-0 aspect-square" type="button" @click="handleTimeChange('minute', minute)">
    ...
    <div class="flex justify-end gap-2 p-2">
        <Button variant="outline" type="button" @click="resetDateTime">
            Reset
        </Button>

...
const LANGUAGE_CONFIGS: Record<string, LanguageConfig> = {
    Java: {
        colors: 'capitalize bg-red-100 text-red-700 dark:bg-red-950/30 dark:text-red-400 border-red-200 dark:border-red-800',
        logo: '/images/java-logo-png.png',
    },
    Python: {
        colors: 'capitalize bg-yellow-100 text-yellow-700 dark:bg-yellow-950/30 dark:text-yellow-400 border-yellow-200 dark:border-yellow-800',
...
const DEFAULT_CONFIG: LanguageConfig = {
    colors: 'capitalize bg-blue-100 text-blue-700 dark:bg-blue-950/30 dark:text-blue-400 border-blue-200 dark:border-blue-800',
    logo: null,
};

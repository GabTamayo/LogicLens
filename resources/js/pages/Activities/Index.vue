...
import { Circle, FolderOpen, ArrowRight, Code2, Calendar } from 'lucide-vue-next';
        ...
        <div class="flex h-full flex-1 flex-col gap-6 p-4 lg:p-6">
            <template v-if="activities.data.length > 0">
                ...
                <div class="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    <Link v-for="activity in activities.data" :key="activity.id" :href="`/activities/${activity.id}`"
                        prefetch="mount" class="block">
                    <Card

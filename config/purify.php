    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,u,strong,i,em,s,del,a[href|title],ul,ol,li,p[style],br,span,img[width|height|alt|src],blockquote,code,pre,u,table[width|height|style|class],thead,tbody,tfoot,tr[style|class],th[colspan|rowspan|scope|style|class|align|valign|width|height],td[colspan|rowspan|style|class|align|valign|width|height]',
